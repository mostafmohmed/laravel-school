                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('Grade.index') }}">    {{  trans('main_trans.Grade_List') }}</a></li>
                    ...
                    <li>
                        <a href="" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text"> {{  trans('Grade_trans.classroom') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('classroom.index')}}">{{  trans('Grade_trans.classroom_list') }} </a> </li>
                            <li> <a href="calendar-list.html">List Calendar</a> </li>
                        </ul>
                    </li>
                    <!-- menu item todo-->
                    <li>
                        <a href="{{ route('section.index') }}"><i class="ti-menu-alt"></i><span class="right-nav-text">
                           section    </span> </a>
                    </li>
                    <!-- menu item chat-->
                    <li>
